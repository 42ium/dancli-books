...
Use ECDICT license terms from the upstream repository.
...
When using CC BY Tatoeba sentence exports, keep sentence id, author, and license
metadata where available. CC0 sentence exports may be easier to redistribute but
